...
//        // The dictionary that serves as an intern set, with the key being a hash code and the value being a tuple where the first item is the reference count
//        private readonly IDictionary<int, InternedReferenceContainer> _internDictionary = null;
...
//            _internDictionary = new Dictionary<int, InternedReferenceContainer>(100);
//        }
...
//            // Attempt to intern the value
//            int hashKey = CalculateHash(value);
//            InternedReferenceContainer internedReference = null;

//            _internDictionaryLock.EnterUpgradeableReadLock();
//            try
//            {
//                // Check if already interned
//                if (!_internDictionary.TryGetValue(hashKey, out internedReference))
//                {
//                    // Not, write lock and intern
...
//                        {
//                            // Intern it
//                            internedReference = new InternedReferenceContainer
//                            { 
//                                Count = 0, 
//                                InternedValue = value
//                            };
//                            _internDictionary[hashKey] = internedReference;
//                        }
//                    }
//                    finally
//                    {
...
//            // Use the interned value
//            _memoryCache.Set(key, internedReference.InternedValue, cacheItemPolicy);
//            // Increment the interned reference count
//            Interlocked.Increment(ref internedReference.Count);
...
//            var value = _memoryCache.Remove(key) as byte[];
...
//            // Check the interned reference count
//            int hashKey = CalculateHash(value);
//            InternedReferenceContainer internedReference = null;
...
//                if (_internDictionary.TryGetValue(hashKey, out internedReference))
//                {
//                    // It is, decrement the reference count
//                    var threadSafeReferenceCount = Interlocked.Decrement(ref internedReference.Count);
//                    // See if we have no more references
//                    if (threadSafeReferenceCount == 0)
//                    {
//                        // Remove the intern so that we don't leak stale reference memory
//                        _internDictionaryLock.EnterWriteLock();
//                        try
//                        {
//                            _internDictionary.Remove(hashKey);
//                        }
//                        finally
//                        {
//                            _internDictionaryLock.ExitWriteLock();
...
//        private int CalculateHash(byte[] value)
//        {
...
//        /// <summary>
//        /// Represents an interned object and its reference count
//        /// </summary>
//        private class InternedReferenceContainer
//        {
//            /// <summary>
//            /// The reference count.
//            /// </summary>
